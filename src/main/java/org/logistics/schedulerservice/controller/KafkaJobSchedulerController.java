...
@Slf4j
@RestController
@RequestMapping("/api/v1/kafka/schedule")
public class KafkaJobSchedulerController {

    private JobService jobService;

    public KafkaJobSchedulerController(@Qualifier("kafkaJobService") JobService jobService) {
